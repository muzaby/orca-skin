        ...
        {lines.map((line, i) => {
          ...
          const gutterBg = isAdded
            ...
            : isRemoved
              ...
              : 'bg-transparent'
          const axis = isRemoved ? 'old' : 'new'
          const tokens = syntax.get(line)?.[axis]
          return (
...
function syntaxText(text: string, tokens: readonly ThemedToken[] | undefined): React.ReactNode {
