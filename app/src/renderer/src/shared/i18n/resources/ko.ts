...
export const ko = {
  ...
  chat: {
    ...
    rightpanel: {
      ...
      diffFileChip: '파일 {{count}}개',
      diffUncommittedChip: '미커밋 {{count}}개',
      diffCommitFileCount: '파일 {{count}}개',
      diffMoreFiles: '+{{count}}개 파일 더',
      diffCollapseFiles: '파일 접기',
      diffSessionFilesTruncated: '세션 파일 목록 제한됨',
      diffSessionCommitsTruncated: '세션 커밋 목록 제한됨',
      diffSessionCommitFilesUnavailable: '커밋별 파일 정보를 가져오지 못함',
      diffPartialFiles: '일부만 표시',
      diffFileMetadataUnavailable: '변경 파일 정보 없음',
      diffUncommittedBlock: '미커밋 변경',
      diffPeekPosition: '{{index}}/{{total}}',
      diffIncludesUncommitted: '미커밋 변경 포함',
      diffPreviousFile: '이전 파일',
      diffNextFile: '다음 파일',
