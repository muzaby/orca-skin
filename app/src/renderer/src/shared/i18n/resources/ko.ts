...
export const ko = {
  background: {
    ...
    resynchronizing: '실행 목록 재동기화 중',
    conflict: '종료 상태 불일치',
    requested: '중단 요청 중',
    acknowledged: '종료 확인 중',
    unconfirmed: '종료 확인 불가',
    stopFailed: '중단 요청 실패',
    launch: '시작 확인 중',
    foreground: '포그라운드',
    background: '백그라운드',
    ...
    changed: '원본 파일이 변경됨',
    truncated: '원본 파일이 잘림',
    remoteOutput: '원격 출력 · 직접 읽기 불가',
    outputHelp: '파일 끝은 작업 완료를 의미하지 않습니다.',
    residual: '종료 확인이 남은 작업: {{count}}',
    residualUnknown: '일부 실행의 종료를 확인할 수 없습니다.',
    noTaskId: '작업 식별자를 아직 받지 못했습니다.',
    seconds: '{{count}}초',
    toolUses: '도구 {{count}}회',
    tokens: '{{count}} 토큰'
  },
  ...
  chat: {
    agent: {
      ...
      activity: '도구 {{tools}}개 사용함',
      activityNotes: '{{notes}} 노트',
      ended: '응답 수신 마감',
      aborted: '응답 중단',
      failed: '응답 오류',
      unknown: '응답 미확정'
