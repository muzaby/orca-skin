...
export const ko = {
  ...
  debug: {
    ...
    scenarios: {
      ...
      agent_task_board: '작업 목록(TaskXXX)',
      error: '에러',
      full: '전체'
    }
  },
  ...
  chat: {
    ...
    artifactViewer: {
      ...
      invalidEncoding: '텍스트 인코딩을 읽을 수 없습니다',
      imageFailed: '이미지를 표시하지 못했습니다',
      empty: '파일이 비어 있습니다',
      copyBusy: '복사 중',
      downloadBusy: '저장 중'
    },
    ...
    gitRow: {
      ...
      noGithubRemote: 'origin의 GitHub 주소를 확인할 수 없습니다',
      checkingRemote: '원격 저장소 확인 중…',
      remoteCheckFailed: '원격 주소 조회에 실패했습니다. 메뉴를 다시 열어 주세요.',
    ...
    composer: {
      ...
      send: '전송',
      sendEnter: '전송 (Enter)',
      diffRequirementTrayAria: 'Diff 요구사항',
      diffRequirementTrayLabel: 'Diff 요구사항 {{count}}개',
    ...
    rightpanel: {
      ...
      diffNotSynced: '새로 고침을 누르거나 턴이 끝나면 표시됩니다.',
      diffRefresh: '새로 고침',
      diffLoadFailed: '변경사항을 불러오지 못했습니다. 새로 고침으로 다시 시도해 주세요.',
      diffCollapsedNotice: '대량 diff의 경우 파일이 축소되어 있습니다. 파일을 선택하면 펼칩니다.',
      diffOpenFile: '탐색기에서 보기',
      diffOpenFileAria: '탐색기에서 보기: {{path}}',
      diffFileToggleAria: '{{path}} 펼치기/접기',
      ...
      diffContextLimited: '문맥이 제한돼 있습니다 — 불러온 범위까지만 펼쳐집니다.',
      diffExpandGap: '위로 {{count}}개 더 표시',
