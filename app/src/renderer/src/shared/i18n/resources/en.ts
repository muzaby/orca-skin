...
export const en: typeof ko = {
  background: {
    ...
    refresh: 'Refresh',
    stop: 'Request stop',
    stopAll: 'Stop all execution',
    waiting: 'Wait for result',
    ...
    resynchronizing: 'Resynchronizing task list',
    conflict: 'Conflicting termination evidence',
    requested: 'Requesting stop',
    acknowledged: 'Awaiting termination',
    unconfirmed: 'Termination unconfirmed',
    stopFailed: 'Stop request failed',
    launch: 'Awaiting start confirmation',
    foreground: 'Foreground',
    background: 'Background',
    remote: 'Remote',
    ambient: 'Internal task',
    retry: 'Retrying',
    heartbeat: 'Connection heartbeat',
    details: 'Invocation and result details',
    conversation: 'Child conversation',
    output: 'Output',
    read: 'Read output',
    more: 'Read more',
    current: 'Current file',
    snapshot: 'Preserved output',
    partial: 'Partial output',
    available: 'Output available',
    missing: 'Output file missing',
    denied: 'Output access denied',
    changed: 'Source file changed',
    truncated: 'Source file truncated',
    remoteOutput: 'Remote output · local read unavailable',
    outputHelp: 'End of file does not mean the task completed.',
    residual: 'Tasks awaiting termination: {{count}}',
    residualUnknown: 'Some execution could not be confirmed terminated.',
    noTaskId: 'The task identifier has not arrived.',
