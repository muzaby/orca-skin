...
export const en: typeof ko = {
  ...
  chat: {
    ...
    rightpanel: {
      ...
      diffFileChip: '{{count}} files',
      diffUncommittedChip: '{{count}} uncommitted',
      diffCommitFileCount: '{{count}} files',
      diffMoreFiles: '+{{count}} more files',
      diffCollapseFiles: 'Collapse files',
      diffSessionFilesTruncated: 'Session file list limited',
      diffSessionCommitsTruncated: 'Session commit list limited',
      diffSessionCommitFilesUnavailable: 'Commit file details unavailable',
      diffPartialFiles: 'Partially shown',
      diffFileMetadataUnavailable: 'File metadata unavailable',
      diffUncommittedBlock: 'Uncommitted changes',
      diffPeekPosition: '{{index}}/{{total}}',
      diffIncludesUncommitted: 'Includes uncommitted changes',
      diffPreviousFile: 'Previous file',
      diffNextFile: 'Next file',
