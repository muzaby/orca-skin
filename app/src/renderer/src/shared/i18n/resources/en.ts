...
export const en: typeof ko = {
  ...
  chat: {
    ...
    artifactViewer: {
      ...
      retry: 'Try again',
      unsupported: 'Preview is not supported for this file format',
      invalidEncoding: 'Cannot read the text encoding',
      imageFailed: 'Could not display the image',
    ...
    gitRow: {
      ...
      noGithubRemote: 'Could not resolve a GitHub URL for origin',
      checkingRemote: 'Checking remote repository…',
      remoteCheckFailed: 'Could not query the remote. Reopen this menu to retry.',
    ...
    rightpanel: {
      ...
      diffNotSynced: 'Refresh to load changes, or wait for the turn to finish.',
      diffRefresh: 'Refresh',
      diffLoadFailed: 'Could not load changes. Refresh to try again.',
