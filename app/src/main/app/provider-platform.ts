...
import type { AuthSpec, Provider, ProviderApi } from '../contracts/auth'
import { runtimeToolFullName } from '../adapters/runtime-tool-policy'
import { evaluateGate } from '../features/gate'
import type { LoginService } from '../features/auth/login'
import type { ProviderRegistry } from '../features/auth/registry'
import type { ProviderStore } from '../features/auth/store'
