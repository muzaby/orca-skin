...
export function createStallTimer(turn: Pick<InflightTurn, 'controller' | 'timedOut'>): StallTimer {
...
export function createIdleTimer(turn: Pick<InflightTurn, 'controller' | 'timedOut'>): IdleTimer {
