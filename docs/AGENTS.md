...
| `IPC_CONTRACT.md` | **Main ↔ Renderer 채널 SSOT** — **총 65 채널 · 20 도메인** (chat 5 · boot 2 · backend 1 · agent 1 · engine 5 · install 2 · update 6 · settings 2 · skills 7 · files 5 · session 6 · project 5 · window 3 · search 1 · mcp 4 · cost 4 · concurrency 1 · permission 2 · notify 1 · debug 2), NormalizedEvent variant, ErrorCategory, 검증 실패 정책, 변경 절차 | IPC 채널 추가/변경할 때. FRONTEND/BACKEND 가 이 문서를 인용. |
