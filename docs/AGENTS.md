...
| `IPC_CONTRACT.md` | **Main ↔ Renderer 채널 SSOT** — **총 79 채널 · 22 도메인** (chat 6 · boot 2 · backend 1 · agent 1 · engine 5 · install 2 · update 6 · settings 2 · skills 7 · files 5 · session 7 · project 6 · window 3 · search 1 · mcp 4 · cost 6 · concurrency 1 · permission 2 · notify 1 · debug 2 · log 1 · auth 8), NormalizedEvent variant, ErrorCategory, 검증 실패 정책, 변경 절차 | IPC 채널 추가/변경할 때. FRONTEND/BACKEND 가 이 문서를 인용. |
