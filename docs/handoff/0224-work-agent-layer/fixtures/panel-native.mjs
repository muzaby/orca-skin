...
const cache = fs.mkdtempSync(
  path.join(app, "node_modules/.cache/orca/panel-r2-"),
);
await require("esbuild").build({
  entryPoints: [path.join(fixture, "panel-native-browser.tsx")],
...
fs.writeFileSync(
  ...
  JSON.stringify(
    {
      scope:
        "Actual RightPanel/ChatTitleBar/task/plan/context components, production store/actions/CSS, synthetic tool/artifact/IPC data. Main persistence is tested separately; no model call.",
  ...
  JSON.stringify(
    {
      ...
      run: [
        ...
        path.join(fixture, "panel-native-runner.cjs"),
        cache,
      ],
    },
    null,
