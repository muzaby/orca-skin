...
const cache = fs.mkdtempSync(
  path.join(app, "node_modules/.cache/orca/panel-r5-"),
);
await require("esbuild").build({
  entryPoints: [path.join(fixture, "panel-r5-native-browser.tsx")],
...
const files = [
  ...
  "components/rightpanel/TaskProgressList.tsx",
  "components/rightpanel/TaskOutputContent.tsx",
  "components/rightpanel/TaskPanelContent.tsx",
  "components/rightpanel/TaskStatusIcon.tsx",
  "components/rightpanel/RightPanelTile.tsx",
  ...
  JSON.stringify(
    {
      ...
      supportingFiles: Object.fromEntries(
        [
          ...
          "src/renderer/src/features/sessions/components/SessionRow.tsx",
          "src/renderer/src/features/sessions/store/sessionsStore.ts",
          "src/renderer/src/app/hooks/useSessionCompletion.ts",
          "src/renderer/src/app/hooks/useSessionHandlers.ts",
          "src/renderer/src/shared/ui/Icon.tsx",
          "src/renderer/src/shared/ui/Popover.tsx",
          "src/renderer/src/shared/api/ipc.ts",
          "src/shared/ipc.ts",
          "src/shared/protocol.ts",
          "src/preload/index.ts",
          "../docs/handoff/0224-work-agent-layer/fixtures/panel-r5-native-browser.tsx",
          "../docs/handoff/0224-work-agent-layer/fixtures/panel-r5-native-runner.cjs",
          "../docs/handoff/0224-work-agent-layer/fixtures/panel-r5-native.mjs",
        ].map((file) => [
          file,
          createHash("sha256")
  ...
  JSON.stringify(
    {
      ...
      run: [
        ...
        path.join(fixture, "panel-r5-native-runner.cjs"),
        cache,
      ],
    },
    null,
