...
현재 표시 계약은 [ΔV3](panel-plan-r3.md)가 일부 대체한다. D-012의 무조건 구역/정적 진행 표시는 D-018, D-013의 상시·메뉴 비활성은 D-019, D-014의 채워진 진행 그림은 D-020, D-015의 cwd 중복 no-op 해석은 D-021로 SUPERSEDED다. 나머지 결정은 유지하며 아래는 r2 기준선을 보존한다.
