...
| `0005-title-completion-fixes`   | impl   | IN_PROGRESS | Claude  | —       | 1      | 0004 사용자 피드백 반영(모델 별칭 `'haiku'` · `settingSources` 제거 · `complete` 호출 경로 정리). **비기능 작업 = Claude 구현** 규칙 첫 적용(루트 AGENTS.md·handoff AGENTS.md·git-template.md 동시 갱신). |
