...
| `0006-composer-status-line`     | impl   | IMPL_DONE | Claude    | b94cc76   | 1      | Codex 구현 완료 — Tier1 pill + Tier2 팝오버 presentational UI 셸, view-model 순수함수/카피 SSOT, 새대화·오늘비용 props 실배선, 요약 스텁, 임시 상태판정 TODO. 게이트 lint/typecheck/test 286 통과. 검증 대기. |
