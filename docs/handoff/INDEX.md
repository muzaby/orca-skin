...
| `0002-cost-token-tracking` | impl | IMPL_DONE | Claude | 4213cad | 1 | 비용·토큰 추적. main(#54–57) 동기화 후 잔여 범위(모델별 영속 + 일/주/월 누적) + 스키마 제시안 통일(`usage_events`→`turn_usage`+`turn_model_usage`)로 재작성. |
