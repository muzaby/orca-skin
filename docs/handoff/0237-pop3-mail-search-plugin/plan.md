...
**현재 규범 증분: ΔV3** — 문서 뒤의 `ΔV3 — 운영 UIDL 호환과 본문 임베드 이미지 제외 (r5)`가 이번 요구의 정본이다. **기존 ΔV2** — §3·§7·§7-A·§10·§11의 `ΔV2` 절이 정본이다. D-022·032·035·039·040과 관련 AC·V·§10·기술 경로의 대체는 이 부속이 정본이다. 과거 구현 보고는 당시 증거로 보존한다.
