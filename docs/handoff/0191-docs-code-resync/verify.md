...
> 라운드 1~4 판정 원문은 이 문서 하단 부록([r4](#부록--라운드-4-검증-fail-원문-보존) · [r3](#부록--라운드-3-검증-fail-원문-보존) · [r2](#부록--라운드-2-검증-fail-원문-보존) · [r1](#부록--라운드-1-검증-fail-원문-보존))에 보존한다. 본문은 재서술하지 않고 링크한다.
