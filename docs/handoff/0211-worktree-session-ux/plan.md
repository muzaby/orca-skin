...
- 신설 **D-069~D-094(26건)**. 대체 **10건** — D-030 → D-086 · D-037 → D-073 · D-039 → D-082 · D-042 → D-073 · D-043 → D-069·D-081 · D-046 → D-094 · D-056 → D-093 · D-061 → D-074·D-075 · D-065 → D-092. 전부 사용자 명시 변경이고 실패로 위장하지 않는다.
...
- **바뀌지 않은 ACTIVE 결정**: D-001~D-008 · D-020 · D-022~D-025 · D-027 · D-031~D-036 · D-038 · D-040 · D-044 · D-045 · D-047~D-055 · D-057~D-060 · D-062~D-064 · D-066~D-068. 특히 **D-035(미추적 완전 제외)는 유지**된다 — D-081 이 지우는 것은 그 사실을 알리던 *문구*이고 조회·목록·수치의 제외는 그대로다. **D-062~D-064(ΔV3 백엔드)도 유지**되고 ΔV4 의 패치 조회가 같은 `run()` 관문을 지난다.
