...
| **Work·Coding 에이전트 계층 도입 계획** | [`handoff/0224-work-agent-layer/plan.md`](handoff/0224-work-agent-layer/plan.md) — 새 핸드오프 설계 · [Work/Code 구조 진단](handoff/0224-work-agent-layer/structural-diagnosis.md) · 근거는 [`Cowork 연구`](etc/study/cowork/README.md) |
