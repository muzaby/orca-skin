...
> **후속 사용자 결정(2026-09-08):** 첫 구현은 커스텀 게시 도구와 모델 사용 지침만 제공한다. 감지 hook/watcher는 실제 누락·오게시 평가 후 필요하다고 판단할 때 보완한다. 아래 감지 단계는 자동 수행할 로드맵이 아니며, 현재 계획은 [0223 plan](../../../handoff/0223-artifact-publisher/plan.md)과 그 평가 설계를 따른다.
