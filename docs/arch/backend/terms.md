...
| **ExtensionBuilder / TurnExtensions** | DB 지침·settings·Skills·plugin 경로·runtime tool snapshot을 모아 턴의 확장 입력을 만든다. 파일 기반 MCP 구성은 배포 경로가 소유한다. | [adapters.md §1](./adapters.md) |
