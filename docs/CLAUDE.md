...
| `IPC_CONTRACT.md` | **Main ↔ Renderer 채널 SSOT** — **총 24 채널** (chat 3 · backend 1 · install 2 · settings 2 · skills 1 · files 1 · session 5 · project 5 · window 3 · search 1), ChatEvent variant, ErrorCode, 변경 절차 | IPC 채널 추가/변경할 때. FRONTEND/BACKEND 가 이 문서를 인용. |
