...
| 항목 | 수 | 정본 |
|---|---|---|
| IPC 채널 | **90** | `app/src/shared/ipc.ts` |
| IPC 도메인 | **24** | `app/src/shared/ipc.ts` |
| NormalizedEvent variant | **28** | `app/src/shared/ipc.ts` |
...
| DB 마이그레이션 | **24** | `app/src/main/infra/db/migrations/` |
