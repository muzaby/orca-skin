...
| 항목 | 수 | 정본 |
|---|---|---|
| IPC 채널 | **80** | `app/src/shared/ipc.ts` |
| IPC 도메인 | **23** | `app/src/shared/ipc.ts` |
| NormalizedEvent variant | **22** | `app/src/shared/ipc.ts` |
